...
import {Check, ChevronDown, Download, LoaderCircle, X} from "lucide-react";
...
export function ModelSelectDialog({ models, selectedId, onSelect }: Props) {
  ...
  const { available, downloading, download } = useModelAvailability(
    models,
    open
  );
