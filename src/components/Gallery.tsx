  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        >
          <div
            className="flex items-center justify-center px-3 py-2.5 border-b border-border/40"
            onClick={onClose}
          >
              ...
              style={
                {
                  ...
                  ["--default-handle-shadow" as any]:
                    "0 0 0 2px rgba(0,0,0,0.35), 0 2px 10px rgba(0,0,0,0.45)",
                } as any
              }
            >
              <img
